...
**Referencias:** 31_EVENTOS.md (payloads), 02_telemetria_y_dashboard.sql (tabla destino)
...
3. **INSERT directo** en `evento_telemetria` (DDL ya entregado en 02_telemetria_y_dashboard.sql). `fecha_creacion` la pone la DB (`CURRENT_TIMESTAMP`), no el cliente.
